...
PYBIND11_MODULE(SparseSolvPy, m)
{
	...
	py::class_<MatSolvers>(m, "MatSolvers")
		...
		.def("solveSGSMRTR_py", py::overload_cast<const int, const double, const int, const SparseMatC&, py::array_t<std::complex<double>>, py::array_t<std::complex<double>>, bool>(&MatSolvers::solveSGSMRTR_py) )
	;
}
