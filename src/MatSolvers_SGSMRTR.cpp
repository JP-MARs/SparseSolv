...
//=======================================================*/
/** 
 * @brief SGS-MRTR solver (calculate norm of rhs internally)
...
//=======================================================*/
/** 
 * @brief SGS-MRTR solver ( input rhs is std::vector)
 * @param init Initialize solution vector by zero or not (if false, user must initialize primaly)
*/
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const std::vector<double>& vecB, std::vector<double>& results, bool init){
	...
	delete[] results_a;
	return bl;*/
	bool bl = solveSGSMRTR(size0, conv_cri, max_ite, matA, vecB.data(), results.data(), init);
	return bl;
}
...
//=======================================================*/
/** 
 * @brief SGS-MRTR solver ( input rhs & output are Eigen vector)
 * @param init Initialize solution vector by zero or not (if false, user must initialize primaly)
*/
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const Eigen::VectorXd& vecB, double *results, bool init){
	...
	delete[] vecBa;
	return bl;*/
	bool bl = solveSGSMRTR(size0, conv_cri, max_ite, matA, vecB.data(), results, init);
	return bl;
}
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const Eigen::VectorXd& vecB, Eigen::VectorXd& results, bool init){
	bool bl = solveSGSMRTR(size0, conv_cri, max_ite, matA, vecB.data(), results.data(), init);
	return bl;
}
...
//=======================================================*/
/** 
 * @brief SGS-MRTR solver (main body, diag. scaling)
*/
...
//=======================================================*/
/** 
 * @brief SGS-MRTR solver (main body, calculate norm of rhs internally)
*/
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri, const int max_ite, const SparseMatC& matA, const Eigen::VectorXcd& vecB, Eigen::VectorXcd& results, bool init){
	bool bl = solveSGSMRTR(size0, conv_cri, max_ite, matA, vecB.data(), results.data(), init);
	return bl;
}
...
//=======================================================*/
/** 
 * @brief SGS-CO-MRTR solver (main, diag. scaling) 
*/
...
//=======================================================*/
/** 
 * @brief SGS-MRTR solver (main body)
*/
...
//=======================================================*/
/** 
 * @brief SGS-CO-MRTR solver (main body)
*/
bool MatSolvers::solveSGSMRTR(const slv_int size, const double conv_cri, const int max_ite, const double normB, 
