/**
 * @file MatSolversEigenMKL.hpp
 * @brief Linear matrix solvers's wrapper for Eigen and MKL
 * このファイルは疎行列の線形ソルバの外部ラッパーを提供します
 * Eigenデフォルトのソルバと、MKL内部のPARDISOソルバのラッパーを実装しています。
 * Eigenのunsupportedにあるソルバのラッパーも実装しています。
 */
...
public:
	...
	static bool solveEigenICCG(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const std::vector<double>& vecB, std::vector<double>& results, bool init=true);
	...
	static bool solveEigenBiCGstab(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const std::vector<double>& vecB, std::vector<double>& results, bool init=true);
	...
	static bool solveEigenICCG(const slv_int size0, const double conv_cri, const int max_ite, const SparseMatC& matA, const std::vector<dcomplex>& vecB, std::vector<dcomplex>& results, bool init=true);
	...
	static bool solveEigenBiCGstab(const slv_int size0, const double conv_cri, const int max_ite, const SparseMatC& matA,  const std::vector<dcomplex>& vecB, std::vector<dcomplex>& results, bool init=false);
	...
	static bool solveEigenBiCGstab_accel(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const std::vector<double>& vecB, std::vector<double>& results, bool init=true);
	...
	static bool solveEigenBiCGstab_accel(const slv_int size0, const double conv_cri, const int max_ite, const SparseMatC& matA,  const std::vector<dcomplex>& vecB, std::vector<dcomplex>& results, bool init=false);
	/*  */
	/*  */
	/* unsupportedのラッパーたち */
	static bool solveEigenGMRES(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const Eigen::VectorXd& vecB, Eigen::VectorXd& results, bool init=false);
	static bool solveEigenGMRES(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const double* vecB, double* results, bool init=false);
	static bool solveEigenGMRES(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, const std::vector<double>& vecB, std::vector<double>& results, bool init=false);
	static bool solveEigenGMRES(const slv_int size0, const double conv_cri, const int max_ite, const SparseMatC& matA, const Eigen::VectorXcd& vecB, Eigen::VectorXcd& results, bool init=false);
	static bool solveEigenGMRES(const slv_int size0, const double conv_cri, const int max_ite, const SparseMatC& matA, const dcomplex* vecB, dcomplex* results, bool init=false);
	static bool solveEigenGMRES(const slv_int size0, const double conv_cri, const int max_ite, const SparseMatC& matA, const std::vector<dcomplex>& vecB, std::vector<dcomplex>& results, bool init=false);
	/*  */
	//
	/* MKLソルバのラッパー */
	//
