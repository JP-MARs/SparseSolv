/**
 * @file MatSolvers_ICCG.cpp
 * @brief ICCG for double 
 */
...
//=======================================================*/
/** 
 * @brief ICCG solver (input rhs is std::vector)
 * @param init Initialize solution vector by zero or not (if false, user must initialize primaly)
*/
bool MatSolvers::solveICCG(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMat& matA, const std::vector<double>& vecB, std::vector<double>& results, bool init){
	...
	bool bl = solveICCG(size0, conv_cri, max_ite, accera, matA, vecB.data(), results.data(), init);
	/*for(slv_int i = 0 ; i < size0 ; i++){
...
//=======================================================*/
/** 
 * @brief ICCG solver (input rhs is Eigen vector)
 * @param init Initialize solution vector by zero or not (if false, user must initialize primaly)
*/
bool MatSolvers::solveICCG(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMat& matA, const Eigen::VectorXd& vecB, double *results, bool init){
	...
	bool bl = solveICCG(size0, conv_cri, max_ite, accera, matA, vecB.data(), results, init);
	//delete[] vecBa;
	return bl;
}
/*//=======================================================
...
//=======================================================*/
/** 
 * @brief ICCG solver (input rhs & output are Eigen vector)
 * @param init Initialize solution vector by zero or not (if false, user must initialize primaly)
*/
bool MatSolvers::solveICCG(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMat& matA, const Eigen::VectorXd& vecB, Eigen::VectorXd& results, bool init){
	bool bl = solveICCG(size0, conv_cri, max_ite, accera, matA, vecB.data(), results.data(), init);
	return bl;
}
