...
public:
	...
	/* Eigen's lappers */
	bool solveEigenBiCGstab_accel_py(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, py::array_t<double> vecB, py::array_t<double> results, bool init=false);
	bool solveEigenBiCGstab_accel_py(const slv_int size0, const double conv_cri, const int max_ite,const SparseMatC& matA, py::array_t<std::complex<double>> vecB, py::array_t<std::complex<double>> results, bool init=false);
	bool solveEigenGMRES_py(const slv_int size0, const double conv_cri, const int max_ite, const SparseMat& matA, py::array_t<double> vecB, py::array_t<double> results, bool init=false);
	bool solveEigenGMRES_py(const slv_int size0, const double conv_cri, const int max_ite,const SparseMatC& matA, py::array_t<std::complex<double>> vecB, py::array_t<std::complex<double>> results, bool init=false);
};
