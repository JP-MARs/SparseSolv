/**
 * @file IncompleteLUT_my
 * @brief I LUT preconditioner class for Eigen's BiCGstab
 */
...
// IWYU pragma: private
#include <000_thirdparty/Eigen/src/IterativeLinearSolvers/InternalHeaderCheck.h>
...
class IncompleteLUT_my : public SparseSolverBase<IncompleteLUT_my<Scalar_, StorageIndex_> > {
 protected:
 ...
 public:
  ...
  explicit IncompleteLUT_my(const MatrixType& mat, const RealScalar& droptol = NumTraits<Scalar>::dummy_precision(),
                         int fillfactor = 10)
 ...
 **/
template <typename Scalar, typename StorageIndex>
const typename IncompleteLUT_my<Scalar, StorageIndex>::FactorType IncompleteLUT_my<Scalar, StorageIndex>::matrixL() const {
 ...
 **/
template <typename Scalar, typename StorageIndex>
const typename IncompleteLUT_my<Scalar, StorageIndex>::FactorType IncompleteLUT_my<Scalar, StorageIndex>::matrixU() const {
...
void IncompleteLUT_my<Scalar, StorageIndex>::analyzePattern(const MatrixType_& amat) {
...
template <typename Scalar, typename StorageIndex>
template <typename MatrixType_>
void IncompleteLUT_my<Scalar, StorageIndex>::factorize(const MatrixType_& amat) {
