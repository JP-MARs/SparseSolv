/**
 * @file MatSolvers_ICCOCG.cpp
 * @brief ICCG for complex<double>
 */
...
//=======================================================*/
/** 
 * @brief ICCOCG solver (input rhs is std::vector)
 * @param init Initialize solution vector by zero or not (if false, user must initialize primaly)
*/
...
//=======================================================*/
/** 
 * @brief ICCOCG solver ( input rhs is Eigen vector)
 * @param init Initialize solution vector by zero or not (if false, user must initialize primaly)
*/
...
bool MatSolvers::solveICCG(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMatC& matA, const Eigen::VectorXcd& vecB, Eigen::VectorXcd& results, bool init){
	bool bl = solveICCG(size0, conv_cri, max_ite, accera, matA, vecB.data(), results.data(), init);
	return bl;
}
