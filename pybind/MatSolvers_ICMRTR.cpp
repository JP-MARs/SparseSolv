...
//=======================================================*/
/** 
 * @brief IC-MRTR solver ( calculate norm of rhs internally)
 */
...
//=======================================================*/
/** 
 * @brief IC-MRTR solver ( input rhs is std::vector)
 */
bool MatSolvers::solveICMRTR(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMat& matA, const std::vector<double>& vecB, std::vector<double>& results, bool init){
	...
	delete[] vecBa;
	delete[] results_a;*/
	bool bl = solveICMRTR(size0, conv_cri, max_ite, accera, matA, vecB.data(), results.data(), init);
	return bl;
}
...
//=======================================================*/
/** 
 * @brief IC-MRTR solver ( input rhs is Eigen vector)
 */
bool MatSolvers::solveICMRTR(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMat& matA, const Eigen::VectorXd& vecB, double *results, bool init){
	...
	delete[] vecBa;
	return bl;*/
	bool bl = solveICMRTR(size0, conv_cri, max_ite, accera, matA, vecB.data(), results, init);
	return bl;
}
bool MatSolvers::solveICMRTR(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMat& matA, const Eigen::VectorXd& vecB, Eigen::VectorXd& results, bool init){
	bool bl = solveICMRTR(size0, conv_cri, max_ite, accera, matA, vecB.data(), results.data(), init);
	return bl;
}
...
//=======================================================*/
/** 
 * @brief IC-MRTR solver ( diag auto determine)
 */
...
//=======================================================*/
/** 
 * @brief IC-MRTR solver ( diag. scaling)
 */
...
bool MatSolvers::solveICMRTR(const slv_int size0, const double conv_cri, const int max_ite, const double accera, const SparseMatC& matA, const Eigen::VectorXcd& vecB, Eigen::VectorXcd& results, bool init){
	bool bl = solveICMRTR(size0, conv_cri, max_ite, accera, matA, vecB.data(), results.data(), init);
	return bl;
}
...
//=======================================================*/
/** 
 * @brief IC-MRTR solver (main body)
 */
...
//=======================================================*/
/** 
 * @brief IC-CO-MRTR solver (main body)
 */
bool MatSolvers::solveICMRTR(const slv_int size, const double conv_cri, const int max_ite, const double normB, 
